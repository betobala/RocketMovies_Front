import { Container, MovieInfo, NameRate, Author, Tags, Description } from "./styles";
              ...
              <NameRate>
                ...
                <Description>
                  <p>Pragas nas colheitas fizeram a civilização humana 
                    ...
                    que tenta se comunicar com ela. Pai e filha descobrem que o 
                    "fantasma" é uma inteligência desconhecida que está enviando
                     mensagens codificadas através de radiação gravitacional, 
                     ...
                     revela que um buraco de minhoca foi aberto perto de Saturno e 
                     que ele leva a planetas que podem oferecer condições de sobrevivência 
                     para a espécie humana. As "missões Lázaro" enviadas anos antes identificaram 
                     três planetas potencialmente habitáveis orbitando o buraco negro Gargântua: Miller,
                      Edmunds e Mann – nomeados em homenagem aos astronautas que os pesquisaram. Brand 
                      recruta Cooper para pilotar a nave espacial Endurance e recuperar os dados dos
                       astronautas; se um dos planetas se mostrar habitável, a humanidade irá seguir
                        para ele na instalação da NASA, que é na realidade uma enorme estação espacial.
                         A partida de Cooper devasta Murphy.<br /><br />
                      ...
                      Além de Cooper, a tripulação da Endurance é formada pela bióloga Amelia, filha de Brand;
                       ...
                       no buraco de minhoca e se dirigem a Miller, porém descobrem que o planeta possui enorme
